"""ppg_afe Sensor Data Visualization Tool."""
...
st.set_page_config(
    page_title="ppg_afe", page_icon="~", layout="wide",
...
if data is None or data["df"].empty:
    ...
    <div style="text-align:center; padding: 6rem 2rem; color: #aaa;">
        ...
        <div style="font-size: 0.85rem; margin-top: 0.5rem;">Supports ppg_afe .xlsx exports and generic CSV files</div>
    </div>
    """, unsafe_allow_html=True)
    st.stop()
